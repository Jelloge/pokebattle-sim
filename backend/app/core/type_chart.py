"""Type effectiveness chart and stat stage multipliers."""

TYPE_ADVANTAGE: dict[str, dict[str, float]] = {
    "Normal": {
    ...
    "Fairy": {
        ...
        "Ice": 1, "Fighting": 2, "Poison": 1, "Ground": 0.5, "Flying": 1,
        "Psychic": 1, "Bug": 1, "Rock": 1, "Ghost": 1, "Dragon": 2,
        "Dark": 2, "Steel": 0.5, "Fairy": 1,
    },
}

STAT_STAGES: dict[int, float] = {
...
def get_type_multiplier(move_type: str, defender_types: list[str]) -> float:
    ...
    multiplier = 1.0
    chart = TYPE_ADVANTAGE.get(move_type, {})
